...
const Detail = () => {
  ...
  return (
   ...
   <Image src = {`https://image.tmdb.org/t/p/w500/${data?.backdrop_path}`} alt = "Image not absence"
       ...
       <h1 className='md:ml-10 md:mx-0 text-2xl font-semibold mx-5 lg:text-start text-center dark:text-violet-800'>{data?.title}</h1>
        <p className='md:ml-10 md:mx-0 mx-5 lg:text-start text-center dark:text-violet-800'>{data?.overview}</p>
